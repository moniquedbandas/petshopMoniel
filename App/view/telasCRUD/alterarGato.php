...
<body class="m-0 border-0 m-0 border-0">
    <header class="areaHeader">
        ...
        <nav class="menuHeader">
            <ul>
                <li><a href="../telasCRUD/listarGato.php"><strong>Voltar</strong></a></li>
            </ul>
        </nav>
    </header>
            ...
            <div class="table table-responsive text-center">
                <table class="table caption-top">
                    ...
                    <tbody>
                        ...
                        $res = GatoController::resgataPorID($_REQUEST['idGato']);
                        if ($res) {
                            $row = $res;
                        ?>
                            <tr>
                                ...
                                <td><input type="text" name="temperamento" value="<?= $row->temperamento ?>" required></td>
                        ...
                        <?php
                            ...
                            echo "<tr><td colspan='6'>Nenhum gato encontrado.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
